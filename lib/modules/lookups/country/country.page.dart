...
class _CountryPageState extends MahgState<CountryPage, CountryController> {
  ...
  Widget get getTable => (controller.countries == null)
      ? const CircularProgressIndicator.adaptive()
      : (controller.countries?.isEmpty ?? false)
          ? ConstText.lightText(
              text: 'No Data Found',
          ...
          : CustomSyncFusionTable(
              ...
              generalList: controller.countries
                      ?.map((e) => {
                            ...e.toJson(),
                            'actions': e.id,
                ...
                Row(
                  ...
                  children: [
                    ...
                    PopupMenuButton(
                      ...
                      onSelected: (index) {
                        if (index == 1) {
                          context.navigateNamedTo('/countryDetails?id=');
                        }
                      },
                    )
                    // FxButton(
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          IconButton(
            onPressed: () async {
              context.navigateNamedTo('/countryDetails?id=$value');
            },
          ...
          IconButton(
            onPressed: () async {
              await controller.deleteCountryHandler(value);
            },
            icon: Icon(
              Icons.delete,
              color: Colors.red,
