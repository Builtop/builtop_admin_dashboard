...
import 'package:builtop_admin_dashboard/widgets/half_chart.dart';
import 'package:fl_chart/fl_chart.dart';
import 'package:flutter/material.dart';
import 'package:flutterx/flutterx.dart';

class MonthlyearningWidget extends StatefulWidget {
  const MonthlyearningWidget({Key? key}) : super(key: key);

  @override
  State<MonthlyearningWidget> createState() => _MonthlyearningWidgetState();
}

class _MonthlyearningWidgetState extends State<MonthlyearningWidget> {
                  ...
                  ? Expanded(
                      child: Column(
                        children: [
                          ...
                          Expanded(
                            child: _monthEarning(
                              durationText: 'thisMonth',
                              salesAmount: '\u{20B9}25,234',
                              descriptionText: 'chartLorem',
                            ),
                          ),
                          FxBox.h16,
                          Expanded(
                            child: _monthEarning(
                              durationText: 'lastMonth',
